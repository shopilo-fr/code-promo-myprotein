#!/usr/bin/env python3
"""
Recuperation des codes promo Myprotein depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/myprotein.com
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/myprotein.com"
STORE_NAME = "Myprotein"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Myprotein depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-myprotein)"
    }
    try:
